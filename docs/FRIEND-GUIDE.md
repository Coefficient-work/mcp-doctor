...
```bash
npx github:louisreid/mcp-doctor inspect vooma
```

Save the report:

```bash
npx github:louisreid/mcp-doctor inspect vooma -o vooma-mcp-report.md
```
...
```bash
npx github:louisreid/mcp-doctor inspect vooma --config /path/to/mcp.json -o report.md
```
