...
import { FIRST_RUN_NOTICE, TELEMETRY_INGESTION_ENABLED, formatTelemetryStatus, loadTelemetryConfig, maybeShowFirstRunNotice, resolveTelemetryStatus, saveTelemetryConfig, } from "./telemetry.js";
describe("telemetry", () => {
    ...
    it("writes a first-run notice without sending events", () => {
        ...
        const saved = JSON.parse(readFileSync(join(dir, "telemetry.json"), "utf8"));
